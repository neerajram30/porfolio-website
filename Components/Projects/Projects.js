        ...
        <div className='flex items-center justify-center'>
          <div className='md:grid md:gap-4 md:grid-cols-2 flex flex-col lg:grid-cols-3'>
            ...
            <motion.div
              ...
              <a href='https://github.com/neerajram30/spotify-playlist-dl' target='_blank'
                className=''>
                <div className='md:w-72 w-60 h-80 rounded-lg mt-5 dark:shadow-[#00acee3d]  shadow-project dark:bg-transparent shadow-[#eeeeee3d] bg-blogbg'>
                  <div className='flex justify-between'>
                    <div className='w-10 h-10 ml-5 mt-5'>
                      <a className='text-white text-2xl' href='https://github.com/neerajram30/spotify-playlist-dl'>
                        <Github />
                      </a>
                    </div>
                    {/* <div className='w-10 h-10 mr-5 mt-5'>
                <a className='text-white text-2xl'>
                  ...
                  <div className='ml-5 w-11/12 mr-5'>
                    <p className='text-xl font-bold mt-10 text-white hover:cursor-pointer hover:text-bloghover font-overpass dark:text-twitter'>Spotify Playlist dl</p>
                    <p className='mt-5 text-white'>simple command line tool import spotify playlist to local storage</p>
                  </div>
                  <div className='flex md:space-x-2 space-x-2 md:mt-12 ml-5 mt-5 text-sm md:mr-2 items-start justify-start text-white' >
                    <p className='dark:bg-twitter rounded-sm pl-2 pr-2 p-0.5 bg-hcolor text-white font-overpass font-semibold'>Nodejs</p>
